...
function showSelectAddress( id ,lng , lat) {
    var obj = {
        id:id+'_input',
        mapID:id+'_view',
        lngField:lng,
        ...
        callback:function (val) {
            ...
            if(obj.lngField && !$('#'+obj.lngField).val()){
                $('#'+obj.lngField).val(val.lng);
            }

            if(obj.latField && !$('#'+obj.latField).val()){
                $('#'+obj.latField).val(val.lat);
            }
    ...
    try{
        ...
        if(json && json.address){
            ...
            obj.zoom = json.zoom;
            if(obj.lngField && !$('#'+obj.lngField).val()){
                $('#'+obj.lngField).val(json.lng);
            }

            if(obj.latField && !$('#'+obj.latField).val()){
                $('#'+obj.latField).val(json.lat);
            }
